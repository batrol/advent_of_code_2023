...
foreach ($input as $line) {
    ...
    foreach ($translate as $word => $number) {
        if (substr_count($line, $word)){
...
//
//    $currentResult = current($matches);
//
//    if (count($matches[0]) === 1) {
//        $result[] = $currentResult[0] . $currentResult[0];
//
//        continue;
//    }
//
//    $result[] = $currentResult[0] . end($currentResult);
//}

echo 'the calibration value is ' . array_sum($result);